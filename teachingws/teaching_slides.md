...
@p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/green_lcolor-full}

# A good start: explaining Green's proposal (II)

- Prolog is the materialization of this dream::

@p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/green_lcolor-prolog}
...
@p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/search_cases_small}
...
@p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/search_cases_df_small}
...
@p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/search_cases_bf_small} 
...
@p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/data-id-1500-1500-10000-to-include}
...
- Recognizing the sequence of characters accepted by the following *non-deterministic, finite automaton* (NDFA):
  @p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/autom1_color}
...
- *Rules:*
  ...
  @p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/hanoi}{1000}{325}
...
- *Example:*
  @p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/hanoi3}{1000}{115}
...
- A general rule:
  @p @image{https://github.com/mherme/ald-tests/blob/main/teachingws/Figs/hanoi_gen}{1000}{65}
